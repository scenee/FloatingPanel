...
public protocol FloatingPanelCoordinator {
    ...
    /// The delegate that handles callbacks from the FloatingPanelController.
    ///
    /// You can implement a custom delegate to control panel behavior, layout, and animations.
    var delegate: FloatingPanelControllerDelegate? { get }
...
public final class FloatingPanelDefaultCoordinator: FloatingPanelCoordinator {
    ...
    public let delegate: FloatingPanelControllerDelegate?
