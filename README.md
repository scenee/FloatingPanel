...
- [Installation](#installation)
  ...
  - [CocoaPods](#cocoapods)
- [Getting Started on SwiftUI](#getting-started-on-swiftui)
  - [Adding a floating panel on a view](#adding-a-floating-panel-on-a-view)
  - [Presenting a floating panel as a modality on a view](#presenting-a-floating-panel-as-a-modality-on-a-view)
  - [Displaying multiple panels](#displaying-multiple-panels)
- [Getting Started on UIKit](#getting-started-on-uikit)
  - [Adding a floating panel as a child view controller](#adding-a-floating-panel-as-a-child-view-controller)
  - [Presenting a floating panel as a modality](#presenting-a-floating-panel-as-a-modality)
...
## Getting Started on SwiftUI

### Adding a floating panel on a view
...
### Presenting a floating panel as a modality on a view
...
Multiple floating panels can be used in the same view hierarchy. To customize the layout and behavior for each Floating Panel individually, place modifiers directly below each panel.
...
### Presenting a floating panel as a modality
